...
def upgrade() -> None:
    ...
    sa.Column('category', sa.Enum('ART', 'MUSIC', 'THEATER', 'LITERATURE', 'CINEMA', 'DANCE', 'OTHER', name='eventcategory'), nullable=False),
    sa.Column('region', sa.Enum('METROPOLITANA', 'VALPARAISO', 'BIOBIO', 'ONLINE', name='eventregion'), nullable=False),
